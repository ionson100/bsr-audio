...
var BsrAudio = /** @class */ (function (_super) {
    ...
    function BsrAudio(props) {
        ...
        _this.renderLoop = function () {
            if (_this.state.loop) {
                return (jsxs("svg", __assign({ stroke: "currentColor", fill: "none", "stroke-width": "2", viewBox: "0 0 24 24", "stroke-linecap": "round", "stroke-linejoin": "round", className: "audio-icon", height: "20", width: "20", xmlns: "http://www.w3.org/2000/svg", onClick: function () {
        ...
        _this.renderButton = function () {
            switch (_this.state.button) {
                case 0: {
                    return (jsx("svg", __assign({ stroke: "currentColor", fill: "currentColor", "stroke-width": "0", viewBox: "0 0 512 512", className: "audio-icon", height: "25", width: "25", xmlns: "http://www.w3.org/2000/svg", onClick: function () {
                            _this.playAudio();
    ...
    BsrAudio.prototype.render = function () {
        ...
        return (jsxs("div", __assign({ id: this.props.id, className: 'audio-box no-select', style: this.props.style }, { children: [jsxs("div", __assign({ className: 'box-flex' }, { children: [jsx("div", __assign({ className: 'audio-label-host' }, { children: this.props.label })), jsx("svg", __assign({ stroke: "currentColor", fill: "currentColor", "stroke-width": "0", viewBox: "0 0 24 24", id: "a-b-1", className: "audio-icon", height: "20", width: "20", xmlns: "http://www.w3.org/2000/svg", style: { display: this.props.useButtonClose ? 'block' : 'none' }, onClick: function () {
                            ...
                            } }, { children: jsx("path", { fill: "none", "stroke-width": "2", d: "M3,3 L21,21 M3,21 L21,3" }) }))] })), jsx("audio", { autoPlay: this.props.autoPlay, src: this.props.url, ref: this.audioRef, loop: this.state.loop, onLoadedMetadata: this.handleLoadedMetadata, onTimeUpdate: this.handleTimeUpdate, onPlay: function () {
